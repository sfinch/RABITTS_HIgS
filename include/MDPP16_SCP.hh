...
// used to generate this class and read the Tree.
    if (run_num<10){
        file = new TFile(Form("data_root/HIgS_00%i.root", run_num));
    }
    else if (run_num<100){
        file = new TFile(Form("data_root/HIgS_0%i.root", run_num));
    }
    else{
        file = new TFile(Form("data_root/HIgS_%i.root", run_num));
    }
