...
void analysis_6s9s_July(int run_num){

    //Variables
    const int num_det = 2;
    const int num_win = 4*9;
    ...
    //cuts
    double time_irr[2] = {0.0, 6.0};
    double time_count[2] = {6.4, 15.4};
    //double time_count[2] = {0.4, 9.4};
    //double time_irr[2] = {9.8, 15.8};

    double time_win[num_win][2];
    for (int i=0; i<num_win; i++){
        time_win[i][0] = 0.25*i+6.4;
        time_win[i][1] = (0.25*(i+1))+6.4;
    }
